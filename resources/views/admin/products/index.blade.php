<x-app-layout>
    ...
    <div class="container mx-auto">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-medium">Gerenciamento de Produtos</h2>
            ...
            <form method="GET" action="{{ route('admin.products.index') }}" class="flex space-x-4">
                ...
                <button type="submit" class="btn-filter bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                    ...
                    <a href="{{ route('admin.products.create') }}" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-700">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-2 flex justify-between items-center">
                            ...
                            <!-- Link para Detalhes -->
                            <a href="#" class="text-blue-500 hover:text-blue-700 text-sm font-medium">Ver Detalhes</a>
                        </div>
                    </div>
                </div>
            @endforeach
