...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.products.index', compact('products', 'categories', 'stores')); // Redireciona para a view Blade 'index'
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.edit', compact('product', 'categories', 'stores')); // Retorna para a view de edição do produto
    }
